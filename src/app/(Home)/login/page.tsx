...
export default function LoginPage() {
  ...
  return (
    <section className="bg-base-100 Orbitron h-[calc(100vh-160px)] lg:h-[calc(100vh-174px)] flex items-center justify-center">
            ...
            <fieldset className="fieldset">
              ...
              <div className="flex flex-row gap-2">
                <div className="join">
                  ...
                  <button
                    type="button"
                    className="btn btn-neutral join-item px-4 py-2 roboto"
